...
(function (isNode) {
     ...
     * @param {Boolean} [options.saveEmpty] indicates whether to save empty coverage data in `__empty_coverage__`.
     *      Defaults to `false`
     *
     */
    ...
    Instrumenter.prototype = {
        ...
        instrumentASTSync: function (program, filename, originalCode) {
            ...
            if ( this.opts.saveEmpty ) {
                global.__empty_coverage__ = global.__empty_coverage__ || {};
                global.__empty_coverage__[this.coverState.path] = this.coverState;
            }
        ...
        instrument: function (code, filename, callback) {
            ...
            try {
                ...
                console.log( 'Unable to instrument: ' + filename );
                callback( null, code );
            }
        },
        /**
